PROGRAM three
        ...
        REAL :: a,smass_min, smass_max, smas, me, w, median, q_25, q_75 ,abin,c, pe, ps,nuvr,ur,ssfr,dn4000
        REAl, DIMENSION(n) :: smass1, met1, wp1, smass2, met2, wp2
...
!***************************************************************************
        ...
        h = 0
        do i=1,n
                read(10,*) a,a,a,a,ur,a,a,c,smas,a,ssfr,dn4000,me,w,a,a,a,a,pe,ps,nuvr
                if (smas < 8.) cycle 
                if (dn4000 < 0 .or. dn4000 > 3) cycle
                
                
                if (nuvr > 5. .and. nuvr<20.) then
                        k = k + 1
                        smass1(k) = smas
                        met1(k)   = dn4000
                        wp1(k)    = w
...
!************************************************************************
       ...
       ! enddo
        ...
        open(14,file='53b_red.dat',status='unknown')
        l = 0
        do i=1,bines
                do j=1,k
                        !if (smass(j) < 8.) cycle
        ...
        abin=(smass_max-smass_min)/real(bines)
        open(14,file='53b_blue.dat',status='unknown')
        l = 0
        do i=1,bines
                do j=1,h
                        !if (smass(j) < 8.) cycle
