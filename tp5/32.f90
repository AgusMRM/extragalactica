PROGRAM three
        ...
        REAL :: a,smass_min, smass_max, smas, me, w, median, q_25, q_75 ,abin,c, pe, ps
...
!***************************************************************************
        ...
        h = 0
        do i=1,n
                read(10,*) a,a,a,a,a,a,a,c,smas,a,a,a,me,w,a,a,a,a,pe,ps
                if (smas < 8.) cycle 
                if (me < -90.) cycle
                if (pe > .8) then
                        k = k + 1
...
!************************************************************************
       ...
       ! enddo
        ...
        open(14,file='32E.dat',status='unknown')
        l = 0
        do i=1,bines
                do j=1,k
                        !if (smass(j) < 8.) cycle
        ...
        abin=(smass_max-smass_min)/real(bines)
        open(14,file='32L.dat',status='unknown')
        l = 0
        do i=1,bines
                do j=1,h
                        !if (smass(j) < 8.) cycle
