PROGRAM three
        ...
        REAL :: a,smass_min, smass_max, smas, me, w, median, q_25, q_75 ,abin,c, pe, ps,nuvr,ur,Dn
...
!***************************************************************************
        ...
        h = 0
        do i=1,n
                read(10,*) a,a,a,a,ur,a,a,c,smas,a,a,Dn,me,w,a,a,a,a,pe,ps,nuvr
                if (smas < 8.) cycle 
                if (me < -90.) cycle
                
                
                if (Dn > 1.6 .and. Dn < 4) then
                        k = k + 1
                        smass1(k) = smas
                        met1(k)   = me
                        wp1(k)    = 1.
...
!************************************************************************
       ...
       ! enddo
        ...
        open(14,file='medianared_dn.dat',status='unknown')
        l = 0
        do i=1,bines
                do j=1,k
                        !if (smass(j) < 8.) cycle
        ...
        abin=(smass_max-smass_min)/real(bines)
        open(14,file='medianaSblue_dn.dat',status='unknown')
        l = 0
        do i=1,bines
                do j=1,h
                        !if (smass(j) < 8.) cycle
