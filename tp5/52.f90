PROGRAM three
        ...
        REAL :: a,smass_min, smass_max, smas, me, w, median, q_25, q_75 ,abin,c, pe, ps,ssfr,dn4000
...
!***************************************************************************
        ...
        h = 0
        do i=1,n
                read(10,*) a,a,a,a,a,a,a,c,smas,a,ssfr,Dn4000,me,w,a,a,a,a,pe,ps
                if (smas < 8.) cycle 
...
!************************************************************************
       ...
       ! enddo
        ...
        open(14,file='52E.dat',status='unknown')
        l = 0
        do i=1,bines
                do j=1,k
                        !if (smass(j) < 8.) cycle
        ...
        abin=(smass_max-smass_min)/real(bines)
        open(14,file='52L.dat',status='unknown')
        l = 0
        do i=1,bines
                do j=1,h
                        !if (smass(j) < 8.) cycle
